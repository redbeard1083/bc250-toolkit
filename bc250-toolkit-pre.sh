...
show_initial_setup_menu() {
    ...
    print_item  "1"  "Install CachyOS Kernel" "Install linux-cachyos, replacing Deckify kernel"
    ...
    print_item  "9"  "Remove Deckify Kernel"  "Only after verifying linux-cachyos boots correctly"
    echo ""
    print_item  "0"  "Back"                   ""
    echo ""
    echo -e "  ${BOLD}${CYAN}══════════════════════════════════════════════════════════════${RESET}"
